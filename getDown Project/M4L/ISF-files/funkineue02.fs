...
void main() {
	...
	for(int i=0;i < CNT; i++){
		...
		if(layer1enabled) {
			...
			if(i < elements1) {	
				...
				if(time_1[i] > 0.0 && time_1[i] < 0.25){
					...
					arc_1[i] = arc(outside_1,inside_1,modT-1.,arclen_1,LRot_1[i]);			
				...
				if(time_1[i] > 0.25 && time_1[i] < 0.5){
					...
					arc_1[i] = arc(outside_1*bumpT,inside_1,0.,arclen_1,LRot_1[i]);			
					color_1 += vec3(arc_1[i]);					
				...
				if(time_1[i] > 0.5 && time_1[i] < 0.75){
					...
					arc_1[i] = arc(outside_1,inside_1,0.,arclen_1,LRot_1[i]);			
					color_1 += vec3(arc_1[i]);	
				...
				if(time_1[i] > 0.75 && time_1[i] < 1.0){
					...
					arc_1[i] = arc(outside_1,inside_1,modT,arclen_1,LRot_1[i]);			
					color_1 += vec3(arc_1[i]);	
		...
		if(layer2enabled){
			...
			if(i < elements2) {
				...
				if(time_2[i] > 0.0 && time_2[i] < 0.25){
					...
					arc_2[i] = arc(outside_2,inside_2,modT-1.,arclen_2,LRot_2[i]);			
				...
				if(time_2[i] > 0.25 && time_2[i] < 0.5){
					...
					arc_2[i] = arc(outside_2*bumpT,inside_2,0.,arclen_2,LRot_2[i]);			
					color_2 += vec3(arc_2[i]);					
				...
				if(time_2[i] > 0.5 && time_2[i] < 0.75){
					...
					arc_2[i] = arc(outside_2,inside_2,0.,arclen_2,LRot_2[i]);			
					color_2 += vec3(arc_2[i]);	
				...
				if(time_2[i] > 0.75 && time_2[i] < 1.0){
					...
					arc_2[i] = arc(outside_2,inside_2,modT,arclen_2,LRot_2[i]);			
					color_2 += vec3(arc_2[i]);	
		...
		if(layer3enabled){
			...
			if(i < elements3) {	
				...
				if(time_3[i] > 0.0 && time_3[i] < 0.25){
					...
					arc_3[i] = arc(outside_3,inside_3,modT-1.,arclen_3,LRot_3[i]);			
				...
				if(time_3[i] > 0.25 && time_3[i] < 0.5){
					...
					arc_3[i] = arc(outside_3*bumpT,inside_3,0.,arclen_3,LRot_3[i]);			
					color_3 += vec3(arc_3[i]);					
				...
				if(time_3[i] > 0.5 && time_3[i] < 0.75){
					...
					arc_3[i] = arc(outside_3,inside_3,0.,arclen_3,LRot_3[i]);			
					color_3 += vec3(arc_3[i]);	
				...
				if(time_3[i] > 0.75 && time_3[i] < 1.0){
					...
					arc_3[i] = arc(outside_3,inside_3,modT,arclen_3,LRot_3[i]);			
					color_3 += vec3(arc_3[i]);	
		...
		if(layer4enabled){
			...
			if(i < elements4) {	
				...
				if(time_4[i] > 0.0 && time_4[i] < 0.25){
					...
					arc_4[i] = arc(outside_4,inside_4,modT-1.,arclen_4,LRot_4[i]);			
				...
				if(time_4[i] > 0.25 && time_4[i] < 0.5){
					...
					arc_4[i] = arc(outside_4*bumpT,inside_4,0.,arclen_4,LRot_4[i]);			
					color_4 += vec3(arc_4[i]);					
				...
				if(time_4[i] > 0.5 && time_4[i] < 0.75){
					...
					arc_4[i] = arc(outside_4,inside_4,0.,arclen_4,LRot_4[i]);			
					color_4 += vec3(arc_4[i]);	
				...
				if(time_4[i] > 0.75 && time_4[i] < 1.0){
					...
					arc_4[i] = arc(outside_4,inside_4,modT,arclen_4,LRot_4[i]);			
					color_4 += vec3(arc_4[i]);	
		...
		vec3 outColor = color_1*MediumOrchid + color_2*WHITE + color_3*PaleGoldenrod + color_4*WHITE;
